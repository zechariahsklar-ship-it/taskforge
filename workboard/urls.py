...
urlpatterns = [
    ...
    path("workers/tags/new/", views.worker_tag_create_view, name="worker-tag-create"),
    path("workers/tags/<int:pk>/edit/", views.worker_tag_edit_view, name="worker-tag-edit"),
    path("workers/tags/<int:pk>/delete/", views.worker_tag_delete_view, name="worker-tag-delete"),
    path("workers/teams/new/", views.team_create_view, name="team-create"),
