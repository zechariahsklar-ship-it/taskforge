...
from .people_views import (
    ...
    worker_tag_create_view,
    worker_tag_delete_view,
    worker_tag_edit_view,
...
# This module exists so urls.py can `from . import views` and reference every
# view through one name (views.board_view, views.worker_list_view, ...)
# instead of importing from each *_views module directly. __all__ documents
# that re-export as intentional, since none of these names are otherwise
# used within this file itself.
__all__ = [
    "TaskParsingService",
    "admin_guide_view",
    "parse_class_schedule_view",
